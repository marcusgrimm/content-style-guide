...
## Copyright at Aster Pet Sciences

Copyright law applies to nearly every piece of content we create at Aster Pet Sciences, from our website to our blog posts to the gifts we make for our users. We display proper—and prominent—copyright notice on our website site and any other content we produce.

At minimum, these copyright notices read, “&copy; [YEAR] Aster Pet Sciences.”
...
“You grant Aster Pet Sciences a perpetual, worldwide, non-exclusive, royalty free license to display, distribute, and publish the Work in our marketing in any medium now known or later developed.”
...
Social media posts often include copyrighted elements like pictures, GIFs, or pieces of writing. If you’re using a copyrighted element in a commercial manner on social media, you should request permission from the copyright holder. Since Aster Pet Sciences is a company, we defer to the position that our use will be perceived as commercial. But if you’re using it in a more informative or commentary way, like sharing a meme to indicate how you feel about a news story, you may not need to request permission.
...
For this reason, we suggest building social media content inside HootSuite, as it offers a variety of royalty-free images.
...
We usually classify Aster Pet Sciences as a suggestive mark, but it could also be considered fanciful.
...
NOTE: AS OF 2/24/21, APS HAS NOT REGISTERED A TRADEMARK. EDIT TEXT BELOW WHEN COMPLETE.

Here’s how to indicate XXXXX’s trademark:

- Include the &reg; symbol in the upper right-hand corner, above the word: XXXXXX<sup>&reg;</sup> this use is preferable.
- Include the &reg; symbol in the lower right-hand corner, below the word: XXXXXXX<sub>&reg;</sub>
...
## Registering trademarks at Aster Pet Sciences
